...
flightpath = sns.heatmap(data, cmap='coolwarm', center=1, yticklabels=False, xticklabels=False, cbar=False)
flightpath.invert_yaxis()
flightpath.set_ylabel('')
flightpath.set_xlabel('')

# Save a png of the created heatmap
fig = flightpath.get_figure()
fig.savefig("flightpath.png")
